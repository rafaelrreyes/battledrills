		...
		return (
			<div className="attachment">
				<div className="attachment-flex">
					...
					<label className="attachment-label">{displayFilename}</label>
				</div>
				<div className="attachment-buttons">
					<Icon onClick={() => onDownloadClick(attachment)}>{MaterialIconNames.DOWNLOAD}</Icon>
					<Icon onClick={() => onDeleteClick(attachment)}>{MaterialIconNames.DELETE}</Icon>
				</div>
			</div>
		);
	};
