...
import { OwnReportsTaskItem } from "../index";
import { StatusIcon, conditionalTooltipRender } from "CORE/index";
import { STATUS_TYPES } from "UTILITIES/index";
import "./OwnReportsDrills.scss";

const OwnReportsDrills = ({ drills, onDrillColumnClose }) => {
...
const renderDrillTable = (drill) => {
	...
	return tasks.map((task) => {
		return <OwnReportsTaskItem task={task} key={task.taskId} drillName={drillName} />;
	});
};

export default OwnReportsDrills;
